...
public class MessagePathProvider {
    ...
    public static ConfigPair DIMENSION_PORTAL_MISSING_PERMISSION = new ConfigPair("dimensionPortalMissingPermission", "<red>You are not able to create portals through differents worlds.");
